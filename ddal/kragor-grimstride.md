...
| | |
| --- | --- |
| Character Name | [Kragor Grimstride](https://www.dndbeyond.com/characters/161063983) |
...
| Award |
| --- |
| Heroes of Citadel Adbar |
| Ire of the Frost Giants |
...
|  | Bastion — Creation |  |  |
|  | Bastion — Turn |  | -7 |
|  | Bastion · Storehouse: Procure — Goods | -320 |  |
...
### 2025-11-20 — In Dire Need

::: adventure

| Adventure Code | Adventure Name | DM |
| --- | --- | --- |
| DDAL-05-04 | In Dire Need | Jay Africa |
...
Rescued the Frostbite Platoon from an ogre troop.

**Magic Items:** Potion of Climbing (Consumable), Potion of Greater Healing (Consumable) ×2, Mithral Splint Mail (Uncommon)
...
### 2025-11-25 — Losing Fai

::: adventure

| Adventure Code | Adventure Name | DM |
| --- | --- | --- |
| DDAL-09-11 | Losing Fai | Orion Renard |
...
We saved Fai Chen and his clones and brought them back to Mahadi’s Wandering Emporium, and told Mahadi about Su Zhen Kang’s betrayal.

**Magic Items:** Potion of Greater Healing (Consumable), Potion of Poison (Consumable), Staff of Charming (Rare)
...
| Date | Activity | GP | DT |
| --- | --- | --- | --- |
| 2025-11-26 | Bastion — Turn |  | -7 |
|  | Bastion · Storehouse: Procure — Goods | -190 |  |
|  | Bastion · Arcane Study: Craft — Arcane Focus Orb |  |  |
...
### 2026-03-05 — Writhing in the Dark

::: adventure

| Adventure Code | Adventure Name | DM |
| --- | --- | --- |
| DDEX-03-13 | Writhing in the Dark | Owen Salsbury |
...
Incomplete: Received mission from the illithid Glor to hunt down Rogue Thought, another illithid considered dangerous. Discovered RT’s lair. Encountered and defeated four Githyanki, rescuing Arriz. Encountered a duergar in some sort of abattoir; she immediately attacked and was killed before we could obtain any information from her. After 3.5h of play, we did not reach Rogue Thought.
...
| Date | Activity | GP | DT |
| --- | --- | --- | --- |
| 2026-03-12 | Purchase Equipment — A gilded flower worth 300gp | -300 |  |
|  | Rebuild — Fighter 1 / Warlock 8 |  |  |
...
|  | Bastion · Workshop: Maintain — Heroic Inspiration |  |  |
| 2026-04-08 | Bastion · Rebuild — Eldritch Invocations |  |  |
...
| Adventure Code | Adventure Name | DM |
| --- | --- | --- |
| CCC-NBDD01-01 | Clever | Owen Salsbury |
...
Protected Harkle in his haberdashery. Infiltrated Tyrex’s hideout. Instead of ending him, we signed on to his gang… at least for now.

**Magic Items:** Potion of Greater Healing (Consumable) ×2, Portable Hole (Rare)
